...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<Student> allStudents() {
        ...
        String sql = "SELECT fName, lName FROM STUDENT ORDER BY lName ASC";
    ...
    public List<Course> csCourses() {
        ...
        String sql = "SELECT courseCode, courseDesc FROM COURSE WHERE teacherId IN (SELECT tid FROM TEACHER WHERE dept ='Computer Science')";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT cs.course_id, c.courseCode, c.courseDesc, COUNT(cs.student_id) AS numStudents " +
            "FROM course_student cs " +
            "JOIN course c ON cs.course_id = c.cid " +
            "GROUP BY cs.course_id, c.courseCode, c.courseDesc";
